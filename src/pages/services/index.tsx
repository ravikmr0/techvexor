...
export default function Services() {
  ...
  const metaTitle = "Services - Vexor Technologies | Digital & AI Solutions";
  ...
  useEffect(() => {
    ...
    document.querySelectorAll('script[type="application/ld+json"][data-services-index-seo]').forEach(el => el.remove());

    // Add schemas
    [servicesSchema, breadcrumbSchema].forEach(schema => {
      const script = document.createElement("script");
      script.type = "application/ld+json";
      script.setAttribute("data-services-index-seo", "true");
