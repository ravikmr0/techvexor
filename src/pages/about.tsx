  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        ...
        description="Learn about Tech Vexor's mission to help businesses grow with AI, web development, digital strategy, and modern software services."
        keywords="about tech vexo, AI agency, web development company, digital growth experts"
      />
      <Header />
  {/* Hero Section */}
