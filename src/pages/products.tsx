...
export default function Products() {
  ...
  const metaTitle = "Products | Tech Vexor";
  const metaDescription = "Browse Tech Vexor's products and solutions for digital growth, automation, and modern business operations.";
  const canonicalUrl = `${BASE_URL}${location.pathname}`;
  const metaKeywords = "tech products, software products, AI products, digital solutions";
